...
function acf_blocks() {
    if ( function_exists( 'acf_register_block_type' ) ) {
        ...
        acf_register_block_type(
            array(
                'name'            => 'cb_service_panel',
                'title'           => __( 'CB Service Panel' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'page-templates/blocks/cb-service-panel.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                'name'            => 'insight_intro',
                'title'           => __( 'Insight Intro' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'page-templates/blocks/insight-intro.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
